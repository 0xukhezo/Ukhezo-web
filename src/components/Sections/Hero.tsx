...
export default function Hero() {
  ...
  return (
    <div className="text-center py-10 lg:mb-20" id="me">
      <h1 className="font-semibold text-5xl py-4 font-anton tracking-widest">About me</h1>
      <div className="max-w-[800px] mx-auto mt-[40px] px-10 font-bitter text-xl">
      ...
      <div className="max-w-[800px] mx-auto mt-[40px] px-10 font-bitter text-xl mb-8">
